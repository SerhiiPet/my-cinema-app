...
public class ShoppingCartDaoImpl implements ShoppingCartDao {
    ...
    public ShoppingCart add(ShoppingCart shoppingCart) {
        logger.info("add method was called. Params: shoppingCart = {}", shoppingCart);
    ...
    public ShoppingCart getByUser(User user) {
        logger.info("getByUser method was called. Params: user.getEmail = {}", user.getEmail());
    ...
    public void update(ShoppingCart shoppingCart) {
        logger.info("update method was called. Params: shoppingCart.getId() = {}",
                shoppingCart.getId());
        Session session = null;
        Transaction transaction = null;
        try {
